...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void initWithContext(Context context) {
		...
		mHeaderViewContent = (RelativeLayout) mHeaderView
				.findViewById(R.id.refresh_listview_header_content);
	...
	public void stopLoadMore() {
		if (mPullLoading) {
			mPullLoading = false;
			mFooterView.setState(RefreshListViewFooter.STATE_LOAD_FINISH);
		}
	}

	/**
	 * finish load more, hide footer view.
	 */
	public void loadMoreFinish() {
		if (mPullLoading) {
			mPullLoading = false;
			mFooterView.setState(RefreshListViewFooter.STATE_DATA_FINISH);
